...
role :app, %w{ubuntu@18.228.157.156}
role :web, %w{ubuntu@18.228.157.156}
role :db, %w{ubuntu@18.228.157.156}
...
set :linked_dirs,  %w{public/uploads public/spree tmp/order_prints tmp/cache}
