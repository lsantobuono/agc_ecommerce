module Spree
  class OrderContents
    ...
    def add(variant, quantity = 1, options = {}, combo_aplicado = nil)
      timestamp = Time.current
      line_item = add_to_line_item(variant, quantity, options, combo_aplicado)
    ...
    def add_to_line_item(variant, quantity, options = {}, combo_aplicado = nil)
      line_item = grab_line_item_by_variant(variant, false, options, combo_aplicado)
      ...
      if line_item
        ...
        line_item = order.line_items.new(quantity: quantity,
                                          variant: variant,
                                          options: opts, combo_aplicado: combo_aplicado)
      end
    ...
    def grab_line_item_by_variant(variant, raise_error = false, options = {}, combo_aplicado = nil)
      if combo_aplicado.nil?
